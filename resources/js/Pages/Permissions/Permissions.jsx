...
const Permissions = ({ auth, permissions }) => {
    return (
        <AuthenticatedLayout user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Permissions</h2>}>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                        <div className="relative overflow-x-auto shadow-s sm:rounded-lg">
                                ...
                                <tbody>
                                    {permissions.map((permission, index) => (
                                        <tr key={permission.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4 text-righ">
